...
Битрикс CModule*/
Class miet_neon extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.neon";
    var $MODULE_ID = "miet.neon";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("neon_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("neon_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("neon_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("neon_PARTNER_URI");
    }
